...
// =====================================================================
// === 4. COMPONENTE PRINCIPAL: DetailsPage ===
// =====================================================================
    ...
    return (
        <div className={`min-h-screen ${bgColor} ${textColor}`}>
            ...
            <div className="relative w-full h-[65vh] md:h-[90vh] overflow-hidden">
                ...
                {/* Contenido Descriptivo y Botones */}
                <div className="absolute bottom-0 left-0 p-6 md:p-12 lg:p-16 w-full text-white z-30 flex flex-col justify-end">
                    ...
                    {/* 2. Metadata Completa (FECHA, HORA, PG Y EMPRESA) */}
            ...
            {/* === 4.2: SECCIÓN DE DETALLES (Sinopsis y Metadata Técnica) - FINAL DE LA PÁGINA === */}
